        ...
        <ul class="sidebar-menu scrollable">
            ...
            <li class="sidebar-item">
                ...
                <ul class="sidebar-link-group">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('feature.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-plus-square"></i></span> <span class="sidebar-txt">Category</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('customerSay.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-cart-shopping-fast"></i></span> <span class="sidebar-txt">Testimonial</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('membership.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-calendar"></i></span> <span class="sidebar-txt">Membership</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
                    ...
                    <li class="sidebar-dropdown-item">
                        <a href="{{ route('orderpricing.index') }}" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-user-plus"></i></span> <span class="sidebar-txt">Customer Orders</span></a>
                    </li>
                    <li class="sidebar-dropdown-item">
