                            ...
                            <tr>
                                <td>
                                    <div class="table-category-card">
                                        <div class="part-icon">
                                            <span><img src="{{ asset('uploads/membership') }}/{{ $membership->image }}" alt=""></span>
                                        </div>
                                        <div class="part-txt" style="width: 120px">
                                            <span class="category-name">{{ $membership->title }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-box">
                                        <a href="{{ route('membership.edit', $membership->id) }}"><i class="fa-light fa-pen-to-square"></i></a>
